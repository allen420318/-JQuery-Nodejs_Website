...
// Clinet 端送來的 DELETE 請求，各 controller 以 delete_actionName 負責處理
app.delete("/", function (request, response) {
    doControllerAction("home", "delete_index", request, response);
});

app.delete("/:controllerName", function (request, response) {
    var controllerName = request.params.controllerName;
    var actionName = request.params.actionName;
    doControllerAction(controllerName, "delete_index", request, response);
});
